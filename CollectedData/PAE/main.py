...
def main(args):
    ...
    if args.alg == 'std_scaling':
        ...
        metric.ence_eval(test_set)
        metric.summary(test_set)
        ...
        if not args.model_path:
            calib_model.set_temeprature(val_loader, test_loader)
        ...
        vis_ae.summary_ence(test_loader)
        vis_ae.summary(test_loader)
...
parser.add_argument('--select', type=str, default='ae', help='which metric to be calibrated')
...
parser.add_argument('--method', type=str, default='reg', choices=['nll', 'reg'])
