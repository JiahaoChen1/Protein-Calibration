...
from dataloader.peptide import Peptide
from dataloader.petptide_3d import Peptide3D
...
def main(args):
    ...
    if args.alg == 'std_scaling':
        ...
        dataset = Peptide(group_id=args.group)
        ...
        dataset = Peptide3D(group_id=args.group)
...
parser.add_argument('--epochs', type=int, default=100, help='batch size. -1 denotes load all samples')
